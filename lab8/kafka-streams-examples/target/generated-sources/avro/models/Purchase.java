...
public class Purchase extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3879011227545109553L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Purchase\",\"namespace\":\"models\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"long\"},{\"name\":\"sum\",\"type\":\"float\"},{\"name\":\"customerId\",\"type\":\"long\"}]}");
   ...
   */
  public static models.Purchase.Builder newBuilder() {
    return new models.Purchase.Builder();
  }
   ...
   * @return A new Purchase RecordBuilder
   */
  public static models.Purchase.Builder newBuilder(models.Purchase.Builder other) {
    if (other == null) {
      return new models.Purchase.Builder();
    } else {
      return new models.Purchase.Builder(other);
    }
  }
   ...
   * @return A new Purchase RecordBuilder
   */
  public static models.Purchase.Builder newBuilder(models.Purchase other) {
    if (other == null) {
      return new models.Purchase.Builder();
    } else {
      return new models.Purchase.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Purchase>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.Purchase.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.Purchase other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder setAmount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder setSum(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder clearSum() {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder setCustomerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Purchase.Builder clearCustomerId() {
