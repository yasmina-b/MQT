...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7073437137033860216L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"models\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"purchaseId\",\"type\":\"long\"}]}");
   ...
   */
  public static models.Payment.Builder newBuilder() {
    return new models.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static models.Payment.Builder newBuilder(models.Payment.Builder other) {
    if (other == null) {
      return new models.Payment.Builder();
    } else {
      return new models.Payment.Builder(other);
    }
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static models.Payment.Builder newBuilder(models.Payment other) {
    if (other == null) {
      return new models.Payment.Builder();
    } else {
      return new models.Payment.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.Payment other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Payment.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Payment.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Payment.Builder setPurchaseId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.Payment.Builder clearPurchaseId() {
