...
public class MapFunctionLambdaKStreamConsumer {
	...
	public static void main(final String[] args) {
		...
		streamsConfiguration.put(StreamsConfig.CLIENT_ID_CONFIG, "map-function-lambda-example-client1");
		...
		final KStream<String, String> uppercasedWithMapValues =
			textLines
